...
const AgeCard = (props) => {
  ...
  return (
    <div className="font-inter overflow-hidden">
      ...
      {data[ageName] - score > 0.5 && <div className="text-[16px] md:text-[18px] font-ptserif flex justify-center text-center mx-4">Based on your results, you have a LOWER wellbeing score compared to the {ageName} age group.</div>} 
      {score - data[ageName] > 0.5 && <div className="text-[16px] md:text-[18px] font-ptserif flex justify-center text-center mx-4">Based on your results, you have a HIGHER wellbeing score compared to the {ageName} age group.</div>} 
      {(data[ageName] - score <= 0.5 && score - data[ageName] <= 0.5)  && <div className="text-[16px] md:text-[18px] font-ptserif flex justify-center text-center mx-4">Based on your results, you have a SIMILAR wellbeing score compared to the {ageName} age group.</div>}<br/>
